...
function esEntero(num) {
   ...
   // Tu código: 
   if(Math.floor(num) || num === 0) return true; return false;
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   var pepepe = String(num);
   if (pepepe.length === 3) return true; return false;
...
function doWhile(num) {
   ...
   do {numero = numero + 5; contador ++} while(contador <= 8); return numero;
